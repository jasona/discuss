...
- Use the repository's .NET test command (for example `dotnet test [optional/project-or-solution]`) to run tests. Running without a path executes all tests found by the solution or current directory context.
